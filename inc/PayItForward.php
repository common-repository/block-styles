	...
	public function sponsors_details() {
		$sponsors = [
			[
				...
				'img'     => plugin_dir_url( BLOCK_STYLES_PLUGIN_FILE ) . 'assets/sponsors/wplemon.png',
				'classes' => '',
			],
		];
		...
		?>
		<div id="block-styles-sponsors">
			<hr style="margin: 5em 0;">
			<p>
				<?php
				printf(
					/* Translators: %s: Red heart emoji/icon. */
					esc_html__( 'This plugin cost you nothing, these amazing people and companies have already paid for it. Spread the %s and keep us going.', 'block-styles' ),
			...
			<p>
				<a href="https://github.com/sponsors/aristath" target="_blank" rel="nofollow">
					<?php esc_html_e( 'Pay it forward for the next people that will install & use it.', 'block-styles' ); ?>
				</a>
			</p>
			<div id="block-styles-sponsors-logos">
		...
		<style>
			...
			/* #block-styles-sponsors:hover,
			#block-styles-sponsors:focus-within {
				opacity: 1;
			} */

			#block-styles-sponsors-logos {
				display: flex;
				justify-content: center;
			}

			#block-styles-sponsors-logos > a {
				padding: 1em;
			}

			#block-styles-sponsors-logos > a img {
				width: auto;
				height: 2em;
			}

			#block-styles-sponsors-logos > a.round img {
				border-radius: 50%;
			}
		</style>
		<?php
